...
public:
    ...
    void actualizar_nivel(QGraphicsScene *scene,float v_limit,float h_limit,QList<personaje*>players,QTimer *timer,vida *conVidas,puntaje *score,tiempo_juego *cont_abs);
